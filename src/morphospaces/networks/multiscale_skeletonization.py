...
class MultiscaleSkeletonizationNet_combined_loss(pl.LightningModule):
    def __init__(
        self,
        in_channels: int = 1,
        image_key: str = "image",
    ...
    def _compute_loss(
        ...
        return (
            self.hparams.scale_0_loss_coefficient * -scale_0_loss + self.hparams.scale_0_loss_coefficient * scale_0_loss1
            + self.hparams.scale_1_loss_coefficient * -scale_1_loss + self.hparams.scale_1_loss_coefficient * scale_1_loss1
            + self.hparams.scale_2_loss_coefficient * -scale_2_loss + self.hparams.scale_2_loss_coefficient * scale_2_loss1
        )
